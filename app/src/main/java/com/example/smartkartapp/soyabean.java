...
public class soyabean extends AppCompatActivity {
    private RecyclerView recyclerView;
    int[] images={R.drawable.sb2,R.drawable.sb3};
    String details[]={"Sb 2","Sb 3"};
    int[] prices={55,60};
    ...
    public void onBackPressed(){
        ...
        final String sph=getIntent().getStringExtra("PHONE");
        final String spa=getIntent().getStringExtra("PASSWORD");
        Intent intent=new Intent(soyabean.this,MensClothing.class);
