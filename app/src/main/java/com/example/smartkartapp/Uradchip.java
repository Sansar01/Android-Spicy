...
public class Uradchip extends AppCompatActivity {
    private RecyclerView recyclerView;
    int[] images={R.drawable.uc1,R.drawable.uc2,R.drawable.uc3,R.drawable.uc4,R.drawable.uc5};
    String details[]={"uc 1","uc 2","uc 3","uc 4","uc 5"};
    int[] prices={69,60,70,80,90};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new RecyclerAdapter(images,details,prices,this,sna,sph,spa,"Uradchip");
    ...
    public void onBackPressed(){
        ...
        final String sph=getIntent().getStringExtra("PHONE");
        final String spa=getIntent().getStringExtra("PASSWORD");
        Intent intent=new Intent(Uradchip.this,HomePageActivity.class);
