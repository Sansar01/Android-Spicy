...
public class DisplayItem extends AppCompatActivity {
    ...
    public void onBackPressed(){
        ...
        final String ca=getIntent().getStringExtra("CALLING_ACTIVITY");
        if(ca.equals("Books")){
            Intent intent=new Intent(DisplayItem.this,Chawal.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("tShirts")){
            Intent intent=new Intent(DisplayItem.this,Moongpapad.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Formals")){
            Intent intent=new Intent(DisplayItem.this,allu.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("BottomWear")){
            Intent intent=new Intent(DisplayItem.this,Uradpapad.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Shoes")){
            Intent intent=new Intent(DisplayItem.this,soyabean.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("WomensClothing")){
            Intent intent=new Intent(DisplayItem.this, jeerapapad.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("Electronics")){
            Intent intent=new Intent(DisplayItem.this, Cchips.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
        }else if(ca.equals("OtherItems")){
            Intent intent=new Intent(DisplayItem.this, Uradchip.class);
            intent.putExtra("NAME",sna);
            intent.putExtra("PHONE",sph);
            intent.putExtra("PASSWORD",spa);
            startActivity(intent);
